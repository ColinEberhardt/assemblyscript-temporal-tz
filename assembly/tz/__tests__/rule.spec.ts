...
describe("matches on date", () => {
  it("matches if year within range", () => {
    ...
    expect(rule.matches(Date.parse("1979-3-1").getTime())).toBe(true);
    expect(rule.matches(Date.parse("1995-3-1").getTime())).toBe(true);
    expect(rule.matches(Date.parse("1978-3-1").getTime())).toBe(false);
    expect(rule.matches(Date.parse("1996-3-1").getTime())).toBe(false);
  });
  ...
  it("matches when toYear is undefined", () => {
    ...
    // note - month is > inMonth
    expect(rule.matches(Date.parse("1979-3-1").getTime())).toBe(true);
    expect(rule.matches(Date.parse("2005-3-1").getTime())).toBe(true);
    expect(rule.matches(Date.parse("1978-3-1").getTime())).toBe(false);
  });
  ...
  it("matches month", () => {
    ...
    expect(rule.matches(Date.parse("1979-01-1").getTime())).toBe(false);
    expect(rule.matches(Date.parse("1979-02-29").getTime())).toBe(true);
    expect(rule.matches(Date.parse("1979-04-29").getTime())).toBe(true);
  });

  it("matches DayOfMonthCalculator rule", () => {
    rule = new Rule("EU", 1979, -1, 2, new DayOfMonth(10), 0, AtTimeZone.UTC, 0);

    expect(rule.matches(Date.parse("1979-02-01T12:00:00").getTime())).toBe(false);
    expect(rule.matches(Date.parse("1979-02-09T12:00:00").getTime())).toBe(false);
    expect(rule.matches(Date.parse("1979-02-10T12:00:00").getTime())).toBe(true);
    expect(rule.matches(Date.parse("1979-02-12T12:00:00").getTime())).toBe(true);
  });

  it("matches time rule", () => {
    rule = new Rule("EU", 1979, -1, 2, new DayOfMonth(10), 120, AtTimeZone.UTC, 0);

    expect(rule.matches(Date.parse("1979-02-10T01:00:00").getTime())).toBe(false);
    expect(rule.matches(Date.parse("1979-02-10T05:00:00").getTime())).toBe(true);
  });
});
